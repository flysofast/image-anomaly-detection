...
# CUDA_VISIBILE_DEVICES=0,1 python main.py  --model Bottleneckv5  --batch_size 32 --exp_name BottleNeckv_5 --seed 42 --crop_size 128 --category bottle --train_mode patch --root_dir dataset